    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '520px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div style={{
          ...
          <div style={{
            height: '4px',
            background: isWin ? '#00d4aa' : isLoss ? '#ff4757' : '#6c63ff',
          }} />
          ...
          <div style={{ padding: '32px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '28px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <span style={{
                  fontSize: '28px', fontWeight: '900', color: '#ffffff', letterSpacing: '-0.5px'
                }}>
                  {trade.instrument}
                </span>
                <span style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '20px' }}>
              {[
                ...
                <div key={i} style={{
                  background: '#1a1a26', borderRadius: '10px', padding: '14px',
                }}>
