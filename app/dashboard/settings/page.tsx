...
export default function Settings() {
    ...
    try {
      ...
      if (tradesToInsert.length === 0) {
        setImportResults({
          ...
          skipped,
          errors: [
            'No valid trades found to import.',
          ],
        })
  ...
  const handleExportCSV = async () => {
    ...
    a.download = `futuresjournal-trades-${
      new Date()
        .toISOString()
        .split('T')[0]
    }.csv`
      ...
      <main className={styles.main}>
        <div className={styles.header}>
          <div>
            ...
            >
              Manage your account and import
              trades
            </p>
          </div>
        </div>
        ...
        <div className={styles.sections}>
          ...
          <div className={styles.card}>
            ...
            <p className={styles.fieldHint}>
              Download all your trades as a
              CSV file. Your data, always
              yours.
            </p>
